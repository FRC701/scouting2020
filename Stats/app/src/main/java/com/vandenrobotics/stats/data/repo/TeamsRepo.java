...
public class TeamsRepo {
    ...
    public static String createTable(){
        return "CREATE TABLE " + Teams.TABLE + "("
                + Teams.KEY_TeamNumber + " INTEGER not null PRIMARY KEY , "
    ...
    public int insert(Teams teams){
        ...
        values.put(Teams.KEY_TeamNumber, teams.getTeamNumber());
    ...
    public void update(Teams teams){
        ...
        //inserting row
        db.update(Teams.TABLE, values, Teams.KEY_TeamNumber + " = " + teams.getTeamNumber(), null);
        DatabaseManager.getInstance().closeDatabase();
    ...
    public ArrayList<Integer> getTeams(){
        ...
        String selectQuery = " SELECT " + Teams.KEY_TeamNumber
                + " FROM " + Teams.TABLE;
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                teamsNum.add(cursor.getInt(cursor.getColumnIndex(Teams.KEY_TeamNumber)));
    ...
    public String getTeamName(int num){
        ...
        String selectQuery = " SELECT " + Teams.KEY_TeamName
                + " FROM " + Teams.TABLE
                + " WHERE Teams." + Teams.KEY_TeamNumber + " = " + num;
